        ...
        <form action="{{ url('/product/update', $item->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nm_product" value="{{ $item->nama_product }}"
                        id="exampleInputEmail1" placeholder="Nama Produk">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="harga" value="{{ $item->harga }}"
                        id="exampleInputJumlah1" placeholder="Jumlah Produk">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="deskripsi" value="{{ $item->deskripsi }}"
                        id="exampleInputdeskripsi1" placeholder="Deskripsi Product">
                </div>
